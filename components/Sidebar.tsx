...
const Sidebar = () => {
  ...
  return (
    <>
      <Image src="/images/cherif.png" className="clearfix mx-auto border rounded-full" height="128px" width="128px" layout="intrinsic" quality="100" />
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="relative flex flex-auto p-6 bg-white justify-evenly dark:bg-dark-200 dark:bg-black-500">
                  <div className="col-span-12 p-2 rounded-lg sm:col-span-6 lg:col-span-4">
                    <Image src="/images/cherif.png" className="mx-auto border" height="128px" width="128px" layout="intrinsic" quality="100" />
                  </div>
                  <div className="col-span-12 p-2 rounded-lg sm:col-span-6 lg:col-span-4">
